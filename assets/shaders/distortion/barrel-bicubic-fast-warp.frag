...
vec4 Filter(vec2 texCoord)
{
	...
	return texture2Dclamp( Texture, Warp(vec2( texCoord0.x, texCoord0.y )) ) * scalingFactor0.x * scalingFactor0.y +
		   texture2Dclamp( Texture, Warp(vec2( texCoord1.x, texCoord0.y )) ) * scalingFactor1.x * scalingFactor0.y +
		   texture2Dclamp( Texture, Warp(vec2( texCoord0.x, texCoord1.y )) ) * scalingFactor0.x * scalingFactor1.y +
		   texture2Dclamp( Texture, Warp(vec2( texCoord1.x, texCoord1.y )) ) * scalingFactor1.x * scalingFactor1.y;
}
